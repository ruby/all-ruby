...
RUN rake -j ${j} all-0     && rm -rf DIST */log */ruby*/ && rdfind -makehardlinks true build/0*

ADD versions/1.0* /all-ruby/versions/
RUN rake -j ${j} all-1.0   && rm -rf DIST */log */ruby*/ && rdfind -makehardlinks true build/1.0*

ADD versions/1.1* /all-ruby/versions/
RUN rake -j ${j} all-1.1a  && rm -rf DIST */log */ruby*/ && rdfind -makehardlinks true build/1.1a*
RUN rake -j ${j} all-1.1b  && rm -rf DIST */log */ruby*/ && rdfind -makehardlinks true build/1.1b*
RUN rake -j ${j} all-1.1c  && rm -rf DIST */log */ruby*/ && rdfind -makehardlinks true build/1.1c*
RUN rake -j ${j} all-1.1d  && rm -rf DIST */log */ruby*/ && rdfind -makehardlinks true build/1.1d*

ADD versions/1.2* /all-ruby/versions/
RUN rake -j ${j} all-1.2   && rm -rf DIST */log */ruby*/ && rdfind -makehardlinks true build/1.2*

ADD versions/1.3* /all-ruby/versions/
RUN rake -j ${j} all-1.3   && rm -rf DIST */log */ruby*/ && rdfind -makehardlinks true build/1.3*

ADD versions/1.4* /all-ruby/versions/
RUN rake -j ${j} all-1.4   && rm -rf DIST */log */ruby*/ && rdfind -makehardlinks true build/1.4*

ADD versions/1.6* /all-ruby/versions/
RUN rake -j ${j} all-1.6   && rm -rf DIST */log */ruby*/ && rdfind -makehardlinks true build/1.6*

ADD versions/1.8.0* versions/1.8.1* versions/1.8.2* versions/1.8.3* versions/1.8.4* /all-ruby/versions/
RUN rake -j ${j} all-1.8   && rm -rf DIST */log */ruby*/ && rdfind -makehardlinks true build/1.8*

ADD versions/1.8.5* /all-ruby/versions/
RUN rake -j ${j} all-1.8.5 && rm -rf DIST */log */ruby*/ && rdfind -makehardlinks true build/1.8.5*

ADD versions/1.8.6* /all-ruby/versions/
RUN rake -j ${j} all-1.8.6 && rm -rf DIST */log */ruby*/ && rdfind -makehardlinks true build/1.8.6*

ADD versions/1.8.7* /all-ruby/versions/
RUN rake -j ${j} all-1.8.7 && rm -rf DIST */log */ruby*/ && rdfind -makehardlinks true build/1.8.7*

ADD versions/1.9.0* /all-ruby/versions/
RUN rake -j ${j} all-1.9.0 && rm -rf DIST */log */ruby*/ && rdfind -makehardlinks true build/1.9.0*

ADD versions/1.9.1* /all-ruby/versions/
RUN rake -j ${j} all-1.9.1 && rm -rf DIST */log */ruby*/ && rdfind -makehardlinks true build/1.9.1*

ADD versions/1.9.2* /all-ruby/versions/
RUN rake -j ${j} all-1.9.2 && rm -rf DIST */log */ruby*/ && rdfind -makehardlinks true build/1.9.2*

ADD versions/1.9.3* /all-ruby/versions/
RUN rake -j ${j} all-1.9.3 && rm -rf DIST */log */ruby*/ && rdfind -makehardlinks true build/1.9.3*

ADD versions/2.0.0* /all-ruby/versions/
RUN rake -j ${j} all-2.0.0 && rm -rf DIST */log */ruby*/ && rdfind -makehardlinks true build/2.0.0*

ADD versions/2.1* /all-ruby/versions/
RUN rake -j ${j} all-2.1   && rm -rf DIST */log */ruby*/ && rdfind -makehardlinks true build/2.1*

ADD versions/2.2* /all-ruby/versions/
RUN rake -j ${j} all-2.2   && rm -rf DIST */log */ruby*/ && rdfind -makehardlinks true build/2.2*

ADD versions/2.3* /all-ruby/versions/
RUN rake -j ${j} all-2.3   && rm -rf DIST */log */ruby*/ && rdfind -makehardlinks true build/2.3*

ADD versions/2.4* /all-ruby/versions/
RUN rake -j ${j} all-2.4   && rm -rf DIST */log */ruby*/ && rdfind -makehardlinks true build/2.4*

ADD versions/2.5* /all-ruby/versions/
RUN rake -j ${j} all-2.5   && rm -rf DIST */log */ruby*/ && rdfind -makehardlinks true build/2.5*

ADD versions/2.6* /all-ruby/versions/
RUN rake -j ${j} all-2.6.0 && rm -rf DIST */log */ruby*/ && rdfind -makehardlinks true build/2.6*
